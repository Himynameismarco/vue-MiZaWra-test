...
<template>
  <div :style="backgroundStyle">
    ...
    <div class="home">
      ...
      <RouterLink class="no-background" :to="{ name: 'writing', params: { submode: 'FREE', title: 'Free Journal' } }"> <!-- To be adapted when submode is free or empty, different writing page will be shown, but for now it forwards to writing page  -->
