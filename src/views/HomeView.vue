...
<template>
  <div :style="backgroundStyle">
    ...
    <div class="home">
      ...
      <RouterLink class="no-background" to="/writing">
...
.home {
  ...
  grid-template-rows: var(--vertical-space-to-first-content) 65px 86px var(--button-height-modes) 152px repeat(3, 1fr); /* 8 */
}
